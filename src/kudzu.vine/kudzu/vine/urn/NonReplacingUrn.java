...
/**
 * The {@code NonReplacingUrn} class represents an {@link Urn}, which removes elements 
 * upon drawing. Thereby drawing elements does alter the {@link Urn}s content.
 * 
 * @author Planters
 *
 * @param <E> - the type of elements contained in the {@link Urn}
 */
public final class NonReplacingUrn<E> implements Urn<E> {
	 ...
	 */
	public NonReplacingUrn(Collection<? extends E> initialContent) {
	...
	/**
	 * Draws a random element from the urn and removes it.
	 * 
	 * @return a random element
	 * @throws IllegalStateException if the {@link Urn} is empty
	 */
	@Override
	public E draw() {
		if (this.isEmpty()) {
		...
		return this.content.remove(ThreadLocalRandom.current().nextInt(this.content.size()));
	}

	/**
	 * Draws a sequence of elements and removes them from the urn.
	 * 
	 * <p>The elements are returned as {@link List} in the order they have 
	 * been drawn from the urn.</p>
	 * 
	 * @param numberOfDraws - the number of times to draw from the {@link Urn}
